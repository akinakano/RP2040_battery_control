...
public:
    ...
    int getDebugCountThGyro() const;
    int getDebugCountThAcc() const;
    void resetQuat();
    void setQuat(const vqf_real_t gyrQuat[4], const vqf_real_t accQuat[4]);
    void getQuat(vqf_real_t gyrQuat[4], vqf_real_t accQuat[4]);
